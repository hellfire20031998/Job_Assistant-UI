export function HowItWorksSection() {
	...
	return (
		<section id="how-it-works" className="border-y border-slate-200/60 bg-slate-50 py-24">
			<div className="container mx-auto px-4 md:px-8">
				...
				<div className="relative grid gap-8 md:grid-cols-3">
					<div className="absolute left-[10%] right-[10%] top-8 hidden h-px bg-gradient-to-r from-slate-200 via-slate-300 to-slate-200 md:block" />

					{steps.map((step, idx) => (
						<div key={idx} className="relative z-10 flex flex-col gap-4 pt-4 md:pt-0">
							<div className="flex h-16 w-16 items-center justify-center rounded-full border-2 border-slate-900 bg-white text-xl font-bold text-slate-900 shadow-sm">
								{step.num}
							</div>
