...
export function HeroSection() {
	...
	return (
		<section className="relative overflow-hidden pt-24 pb-32">
			<div className="pointer-events-none absolute left-1/2 top-0 h-[500px] w-full max-w-4xl -translate-x-1/2 opacity-30">
				<div className="absolute inset-0 rounded-full bg-gradient-to-r from-blue-400 to-violet-400 mix-blend-multiply blur-[100px]" />
			</div>

			<div className="container relative z-10 mx-auto px-4 md:px-8">
				<div className="mx-auto max-w-3xl space-y-8 text-center">
					<div className="mb-4 inline-flex items-center gap-2 rounded-full border border-blue-100 bg-blue-50 px-3 py-1 text-sm font-medium text-blue-700 shadow-sm">
					...
					<div className="flex flex-col items-center justify-center gap-4 pt-4 sm:flex-row">
						<button
							type="button"
							onClick={primaryCta}
							className="flex w-full items-center justify-center gap-2 rounded-full bg-slate-900 px-8 py-3.5 text-base font-semibold text-white shadow-lg shadow-slate-900/20 transition-all hover:bg-slate-800 active:scale-95 sm:w-auto"
						>
						...
						<a
							href="#demo"
							className="flex w-full items-center justify-center gap-2 rounded-full border border-slate-200 bg-white px-8 py-3.5 text-base font-semibold text-slate-700 shadow-sm transition-all hover:bg-slate-50 active:scale-95 sm:w-auto"
						>
							Try Demo
						</a>
					</div>
				...
				<div className="mx-auto mt-20 max-w-5xl">
					<div className="group relative overflow-hidden rounded-2xl border border-slate-200/60 bg-white/50 shadow-2xl backdrop-blur-xl">
						<div className="flex h-12 items-center gap-2 border-b border-slate-100 bg-white px-4">
							<div className="h-3 w-3 rounded-full bg-rose-400" />
							<div className="h-3 w-3 rounded-full bg-amber-400" />
							<div className="h-3 w-3 rounded-full bg-emerald-400" />
							<div className="mx-auto flex items-center gap-1 text-xs font-medium text-slate-400">
								<Bot className="h-3 w-3" /> applyai.app
							</div>
						</div>

						<div className="grid bg-white/60 md:grid-cols-2">
							<div className="border-r border-slate-100 p-6 md:p-8">
								<div className="space-y-4">
									...
									<div className="space-y-2">
										...
										<div className="relative h-32 overflow-hidden rounded-lg border border-slate-200 bg-slate-50 p-3 text-sm text-slate-400">
											<div className="pointer-events-none absolute inset-0 bg-gradient-to-b from-transparent to-slate-50" />
							...
							<div className="bg-slate-50/50 p-6 md:p-8">
								<div className="space-y-4 rounded-xl border border-slate-200 bg-white p-5 shadow-sm transition-shadow duration-500 group-hover:shadow-md">
									<div className="flex items-center gap-2 border-b border-slate-100 pb-4">
										...
										<div>
											...
											<div className="text-xs text-slate-500">To: hiring@vercel.com</div>
										</div>
									</div>
